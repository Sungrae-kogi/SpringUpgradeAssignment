...
import com.sparta.springupgradeschedule.exception.EntityNotFoundByIdException;
...
public class ScheduleService {
    ...
    public ScheduleResponseDTO getSchedule(Long id) {
        ...
        Schedule schedule = scheduleRepository.findById(id).orElseThrow(() -> new RuntimeException("해당 id값을 가진 데이터가 존재하지 않습니다."));
